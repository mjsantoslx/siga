...
<?php foreach($rows as $r): ?><tr><td><a href="<?= e($config['app']['base_url']) ?>/associados/<?= (int)$r['Id'] ?>"><?= e($r['Numero']) ?></a></td><td><?= e($r['Nome']) ?></td><td><?= e($r['DataNascimento']) ?></td><td><?= e($r['Genero']) ?></td><td><?= e($r['Nominativo']??$r['Seccao']??'—') ?></td><td><?= e($r['Companhias']??'—') ?></td><td><?= (int)$r['Activo']?'Activo':'Inactivo' ?></td></tr><?php endforeach; ?>
